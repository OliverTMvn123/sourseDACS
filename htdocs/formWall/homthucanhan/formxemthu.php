            ...
            <ul>
                <li id="listmenu">
                    ...
                    <ul id="showmenu">
                        ...
                        <hr>
                        <!--<li><a href="../sendMail/mail.html"> Gửi Thư</a></li>
                        <hr>-->
                ...
                <?php
                    require '../../homepage/ConnectDB.php';
                       // print_r($_POST);
                        ...
                        {
                                $list= array($row['vandelienquan1'],$row['nguoigui1'],$row['DIACHI1'],$row['Email1'],$row['sendTime'],$row['chude'],$row['noidung1'],$row['anh'],$row['SDT1'],$row['mailID'],$row['verification']);
                                $list1[$i]=$list;
                                
                               if($_POST['so']==$list1[$i][9])
                               {
                                echo'
                                <div class="khung">
                                    <h4>Người gửi : '.$list1[$i][1].'</h4>
                                </div>
                                <div  class="khung">
                                    <h4>Chủ Đề Thắc Mắc:  '.$list1[$i][0].'</h4>
                                </div >
                                <div  class="khung">
                                    <h4>Thời gian gửi :'.$list1[$i][4].' </h4>
                                </div>
                                <div  class="khung">
                                    <h4>Số Điện Thoại :0'.$list1[$i][8].' </h4>
                                </div>
                                <div class="khung">
                                    <h4>Địa Chỉ : '.$list1[$i][2].' </h4>
                                </div>
                                <div class="khung">
                                <h4>Email : '.$list1[$i][3].' </h4>
                                </div>
                                <div class="khung">
                                    <h4>Chủ Đề : '.$list1[$i][5].'</h4>
                                </div>
                                <div class="khung">
                                    <h4>Nội Dung :'.$list1[$i][6].' </h4>
                                </div>
                                <div class="khung">
                                    <h4>Ảnh :'.$list1[$i][7].'</h4>
                                    <img id=anh src="../../sendMail/upload/'.$list1[$i][7].'" alt="">
                                    <img id=anh src="../../sendMail/camera/upload/'.$list1[$i][10].'" alt="">
                                </div>
                            ';
